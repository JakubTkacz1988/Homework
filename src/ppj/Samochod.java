...
public class Samochod extends DzialanieSwiatel implements SwiatlaWSamochodzie  {
	...
	public void SwitaloAwaryjne() {
		...
		else if(samochodStoiKirowcaDziekuje) {System.out.println("Kierowca dziêkuje za wpuszczenie na psa jezdni ");}
